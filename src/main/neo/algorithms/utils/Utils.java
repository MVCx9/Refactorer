...
import main.neo.algorithms.cognitivecomplexity.CognitiveComplexMethod;
import main.neo.algorithms.cognitivecomplexity.Contribution;
...
public class Utils {
	...
	public static ASTNode getASTForMethodAnnotatingContributionToCognitiveComplexity(CompilationUnit compilationUnit,
		...
		try {
			...
			result = main.neo.cem.Utils.findNode(compilationUnit,
			...
			for (Contribution c : l) {
				// Locate node in AST
				node = main.neo.cem.Utils.findNode(compilationUnit,
				...
				int previousValue = main.neo.cem.Utils.getIntegerPropertyOfNode(node,
				...
				previousValue = main.neo.cem.Utils.getIntegerPropertyOfNode(node,
