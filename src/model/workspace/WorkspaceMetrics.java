...
public class WorkspaceMetrics {
	...
	public LocalDate getTimestamp() { return analysisDate; }
	public List<ProjectMetrics> getProjects() { return projects; }
    ...
    /**
     * Media de la suma de la complejidad cognitiva tras refactorizar de todos los proyectos 
     */
